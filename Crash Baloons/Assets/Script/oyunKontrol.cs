...
public class oyunKontrol : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GameObject[] go = GameObject.FindGameObjectsWithTag("balon_tag");//oluþturulan bütün balnlar bu taga sahip olurlar ve diziye atmýþ olacaðýz bunlarý. sonra dizide kalan balonlarý patlatýrýz.
